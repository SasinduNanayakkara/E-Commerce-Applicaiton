...
public class register extends AppCompatActivity {
    ...
    private EditText RegitserEmail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RegitserEmail = findViewById(R.id.RegitserEmail);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String registerEmail = RegitserEmail.getText().toString();
                ...
                if (registerName.isEmpty() || registerEmail.isEmpty() || registerPhoneNumber .isEmpty() || registerAddress.isEmpty() || registerCountry.isEmpty() || registerUsername.isEmpty() || registerPassword.isEmpty()) {
                    ...
                    map.put("registerEmail", registerEmail);
                    map.put("registerPhoneNumber" , registerPhoneNumber);
                    map.put("registerAddress" , registerAddress);
                    map.put("registerCountry" , registerCountry);
                    map.put("registerUsername" , registerUsername);
                    map.put("registerPassword" , registerPassword);

                    FirebaseDatabase.getInstance().getReference().child("honeyBeeDB").child("Users").push().updateChildren(map);
